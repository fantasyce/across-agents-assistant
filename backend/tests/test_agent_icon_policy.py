...
def test_agent_icon_loader_orders_overrides_bundled_and_runtime_icons():
    ...
    assert '"agent.claude-desktop"' in source
...
def test_icon_source_manifest_tracks_local_runtime_icon_policy():
    ...
    assert manifest["runtime_app_icon_agents"]["claude-desktop"] == [
        "/Applications/Claude.app",
        "~/Applications/Claude.app",
        "~/Applications/Claude Code URL Handler.app",
    ]
    assert manifest["runtime_preferred_app_icon_agents"] == ["codex", "claude-desktop"]
