...
def test_autopilot_workbench_does_not_report_claimed_history_as_waiting_queue():
    snapshot = build_autopilot_workbench_snapshot(
        plugins=[{"plugin_id": "across-autopilot", "available": True, "installed": True, "status": "installed"}],
        registry={"built_in": [{"id": "aaa-autonomous-self-iteration"}]},
        trigger_queue={
            "items": [
                {"trigger_id": "trg-old-claimed", "spec": "aaa-autonomous-self-iteration", "status": "claimed"},
                {"trigger_id": "trg-complete", "spec": "aaa-autonomous-self-iteration", "status": "completed"},
            ]
        },
        trigger_registry={
            "triggers": [
