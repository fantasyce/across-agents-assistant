    ...
    sections = {
        ...
        "agent_interop_e2e": _section(
            ...
            "passed" if str(agent_interop_e2e.get("status") or "not_run") == "not_run" else str(agent_interop_e2e.get("status") or "unknown"),
            {
                ...
                "projection_status": _nested(agent_interop_e2e, "summary", "projection_status"),
                "projection_count": _nested(agent_interop_e2e, "summary", "projection_count"),
                "agui_projection_status": _nested(agent_interop_e2e, "summary", "agui_projection_status"),
                "async_task_status": _nested(agent_interop_e2e, "summary", "async_task_status"),
                "context_skills_bridge_status": _nested(agent_interop_e2e, "summary", "context_skills_bridge_status"),
                "computer_use_sandbox_status": _nested(agent_interop_e2e, "summary", "computer_use_sandbox_status"),
                "local_agent_protocol_status": _nested(agent_interop_e2e, "summary", "local_agent_protocol_status"),
